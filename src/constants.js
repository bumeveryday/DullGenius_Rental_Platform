...
**덜지니어스 부원 가입 시 학기 내내 무료 대여**

1. 방에서 예약하고 안전하게 수령하기.
- 방문 수령 예약 기능을 통해 하고싶은 보드게임을 "찜" 하세요.
  다른 사람이 먼저 채갈 일 없으니 안심하고 이용 할 수 있습니다.
- 30분이 지나면 "찜"이 자동 취소되니, 바로 덜지니어스 동아리 방으로 찾으러 오세요.

2. 동아리 오피스아워
- 동아리 오피스아워는 오후 6시부터 오후 9시까지 입니다.
- 오피스아워 앞뒤로도, 동아리에 남아있는 경우가 있습니다.
- 동아리 앞 의자 위에 보드게임을 올려두시면 다음 오피스아워 시작 시 반납됩니다.
...
4. 기타 문의
- 찜하고 싶던 보드게임이 이미 대여 중이라면'아쉬워요' 버튼을 눌러주세요.
  다음 보드게임 구매에 큰 도움이 됩니다.
- 재미있게 플레이한 보드게임이 있다면 리뷰 시스템으로 추천해주세요.
`,
...
- 대여 중 발생한 분실/파손은 대여자에게 책임이 있습니다.`,
  ...
  AGREEMENT_LABEL:
    `(필수) 대여 중 파손 및 분실 발생 시, 2주 이내에 동일 제품 또는 구매가의 4배로 배상하는 것에 동의합니다.`,
...
1. 용어 정리
  1.1 '덜지니어스 내부의 대여'는 다음을 의미한다.
    1. 대여 시스템 '덜지 니어 어스', 'DullGi Near Us'을 통한 대여
...
2. 대여
  ...
  2.1 보드게임의 대여
  보드게임을 대여할 때는 대여 플랫폼 [덜지 니어 어스]를 활용함을 원칙으로 한다. 
...
3. 보드게임의 파손
    보드게임의 배상은, '현물로의 배상'과 '현금으로의 배상'으로 나누어진다.
    현금으로서의 배상은 '구매 가능 보드게임' 의 배상과, '구매 불가능 보드게임'의 배상으로 나누어진다.

    1. 동아리의 보드게임에 대해, 다음의 해를 입힌 경우를 파손으로 정하고, 동아리의 운영진은 심의를 통해 정한 배상을 회칙에 근거해 요구할 수 있다.
    ...
    2. 소유자가 있는 보드게임의 파손 기준은 소유자의 기준으로 정하고, 당사자간의 대화를 통해, 배상을 회칙에 맞게 요구할 수 있다.


4. 배상 
  4.1 현물 배상의 원칙 (우선 적용)
    배상 보드게임의 파손 및 분실에 대한 배상은 '동일 제품으로의 현물 배상'을 최우선 원칙으로 한다. 
    현금 배상은 현물을 구할 수 없는 특수한 경우에 한하여 운영진의 승인 하에 진행한다.
    파손 혹은 분실된 보드게임과 동일한 상품을 구매하여 반납해야 한다.
  ...
  4.3 배상의 항소 및 처리
    ...
    운영진은 게임 진행 불가 수준의 파손이 아니라면, 무리한 전액 배상보다는 부분 파손 보상금(4.2의 2항)을 우선적으로 고려하여 부원의 부담을 줄여야 한다.

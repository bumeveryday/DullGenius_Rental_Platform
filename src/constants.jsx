...
[3초 요약: 대여하는 법]
1. 웹사이트 '로그인' (부원 계정)
2. 원하는 게임을 찾아서 '찜하기' (30분간 유효)
3. 동아리방 방문 후 키오스크로 '대여 확정'

**덜지니어스 부원 가입 시 학기 내내 무료 대여**

1. 로그인 필수
- 대여를 위해 로그인이 필요합니다! 상단 '회원가입'을 통해 계정을 만들어주세요.
- 부원 인증이 완료된 계정만 대여가 가능합니다.

2. 똑똑하게 예약하고 수령하기
- '찜하기' 버튼을 누르면 30분간 해당 게임을 선점할 수 있습니다.
- 30분 내에 동아리방(학관 2층 231호)에 방문하여 수령해주세요.
- 현장에서 키오스크를 통한 수령 확인 후 최종 대여가 완료됩니다. 다음 날 반납하세요!

3. 반납 및 에티켓
- 기본 대여 기간: 1박 2일
- 반납 시 구성품 확인 필수! 회원은 파손/분실 시 신고의 의무가 있고, 자진 신고 시 보상해야하는 비율이 크게 줄어듭니다.
  보드게임 파손 정도에 따라 배상이 청구될 수 있습니다. 자세한 내용은 약관을 참고해주세요.
- 오피스아워(평일 18:00~21:00) 외 반납 시 동아리방 앞 의자에 두고 사진을 찍어두세요.

4. 기타
- '아쉬워요': 원하는 게임이 대여 중일 때 눌러주세요. 수요 조사에 반영됩니다.
- '리뷰': 재미있게 한 게임은 별점과 리뷰를 남겨주세요!
`,

...
export const ORG_RENTAL_TEXTS = {
  ...
  GUIDE_DESC: "한동대학교 총학생회, NGO 등 학내외 자치 기구 및 동아리, 외부 교회 단체 행사 등을 위한 보드게임 대여를 지원합니다. 원활한 대여 진행을 위해 아래 규정을 숙지해 주시기 바랍니다.",
  RULES: [
    { label: "신청 기간", desc: "픽업 희망일 최소 3일 전까지 신청" },
    { label: "최대 개수", desc: "단체당 1회 최대 10개 (협의 가능)" },
    { label: "대여 기간", desc: "협의 후 연장 가능" },
    { label: "보증금", desc: "게임 2개당 5,000원 (반납 시 파손/분실 확인 후 전액 환불)" },
    { label: "수령/반납 장소", desc: "학관 2층 231호 덜지니어스 동아리방" }
  ],
  CAUTION_TITLE: "🚨 주의사항",
  CAUTIONS: [
    "컴포넌트(말, 카드 등) 분실 및 파손 시 정가의 100%를 배상해야 합니다.",
    "반납 기한 연체 시 일자별로 패널티가 발생할 수 있습니다."
